...
WebUI.navigateToUrl('https://sandbox-pos.stagingapps.net/')

WebUI.setViewPortSize(480, 800)

WebUI.setText(findTestObject('Autentikasi/Login/input_email'), 'aininurul@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Autentikasi/Login/div_user tidak terdaftar'), 0)
