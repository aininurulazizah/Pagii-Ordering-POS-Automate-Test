...
WebUI.setText(findTestObject('Autentikasi/Login/input_password'), 'password')

WebUI.click(findTestObject('Autentikasi/Login/button_login'))

WebUI.verifyElementPresent(findTestObject('Autentikasi/Login/div_password salah'), 0)
